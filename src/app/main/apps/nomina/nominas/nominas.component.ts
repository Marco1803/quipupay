...
export class NominasComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.dataSource = new FilesDataSource(this._nominaService, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
    ...
    )
    {
        ...
        this.filteredData = this._nominaService.orders;
    }
    ...
    connect(): Observable<any[]>
    {
        const displayDataChanges = [
            this._nominaService.onOrdersChanged,
        ...
        return merge(...displayDataChanges).pipe(map(() => {
                ...
                let data = this._nominaService.orders.slice();
